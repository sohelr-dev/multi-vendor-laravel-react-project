...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2025 at 07:43 AM
...
(25, '2025_11_25_032930_create_personal_access_tokens_table', 1);
...
CREATE TABLE `order_items` (
  ...
  `per_product_discount` decimal(10,2) NOT NULL,
...
CREATE TABLE `products` (
  ...
  `status` enum('active','pending','draft') NOT NULL DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Sohel Rana', 'sohel@gmail.com', NULL, '$2y$12$aexy7xK994Gn2.tjW5Il3eJ2b72OYFSLtNPAvkhoGquYZGrcwpWPG', NULL, 1, NULL, 'active', NULL, '2025-11-25 00:22:58', '2025-11-25 00:22:58');
